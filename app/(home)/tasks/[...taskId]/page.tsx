...
const page = () => {
  return (
    <div
        ...
        <div className="flex items-center gap-x-4">
          ...
          <AvatarGroup>
            <Avatar className="size-8">
              <AvatarImage className="size-8" src="/images/avatar/avatar-1.png" alt="avatar-1" />
            </Avatar>
            <Avatar className="size-8">
              <AvatarImage className="size-8" src="/images/avatar/avatar-2.png" alt="avatar-2" />
            </Avatar>
            <Avatar className="size-8">
              <AvatarImage className="size-8" src="/images/avatar/avatar-3.png" alt="avatar-3" />
            </Avatar>
            <Avatar className="size-8">
              <AvatarImage className="size-8" src="/images/avatar/avatar-5.png" alt="avatar-5" />
            </Avatar>
          </AvatarGroup>
        </div>
        <div className="flex flex-col items-start gap-y-3.5 md:flex-row md:gap-x-4 md:gap-y-0">
          <div className="flex items-center gap-x-4">
      ...
      <div className="max-w-full space-y-4 lg:max-w-[740px]">
      ...
      <div className="flex flex-col flex-wrap gap-y-3.5 lg:flex-row lg:gap-x-3.5">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="flex w-full items-center justify-between rounded-xl border border-metal-100 px-2.5 py-2 lg:w-[280px] dark:border-metal-800">
