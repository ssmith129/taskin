import { IPaperPlaneTilt, IPlus, ISmileySticker } from '@/components/Icons/Icons'
import FileImage from '@/public/images/files/file.png'
...
const MessageInbox = () => {
  return (
    <div
      id="scroll-bar"
      className="relative col-span-12 overflow-y-scroll px-5 laptop:col-span-8 laptop:h-[calc(100vh-150px)]">
      <div className="py-2">
        <div className="space-y-3">
          <div className="flex items-end gap-2">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <button className="flex items-center gap-1 rounded-md border border-metal-100 bg-metal-25 px-1.5 py-0.5 text-body-4 font-medium text-metal-600 dark:border-metal-800 dark:bg-metal-900 dark:text-metal-300">
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="space-y-2.5">
              <Image src={FileImage} alt="message" />
              <div className="max-w-[273px] rounded-e-xl rounded-t-xl border border-metal-100 p-4 dark:border-metal-800">
          ...
          <Divider variant="center">14 July </Divider>
          <div className="flex items-end gap-2">
            <Avatar className="mb-9 size-10">
      ...
      <div className="sticky bottom-0 left-0 right-0 w-full bg-metal-25 px-5 py-5 dark:bg-metal-900">
        <form>
